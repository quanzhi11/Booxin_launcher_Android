...
> 写给下一个 Agent。仓库：`D:\all code in D\booxin launcher phone`  
> 远程：`https://github.com/quanzhi11/Booxin_launcher_Android.git`（`main`）  
> PC 参考：`D:\all code in D\booxin-launcher2.3.0`  
> 今日：`2026-07-31`；最新提交：`75866b6`（全键盘/组合键）、`620e886`（官服一键进服）
