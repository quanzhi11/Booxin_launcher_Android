...
//        }
    ...
    /**
     * This method is called by SDL using JNI.
     * Booxin: allow binding an external SurfaceView without hosting SDLActivity UI.
     */
    private static Surface sBooxinExternalSurface;

    /** Bind launcher Surface for SDL Android video (zlib SDL embed). */
    public static void booxinAttachSurface(android.content.Context context, Surface surface) {
